...
In original game, all items. In the mods, it's mostly magical jewelry and clothes. For the full list, see [strict.txt](/uniqueartifacts/items/strict.txt) (and expanded.txt).
### How to skip an item?
